...
{title:'Свинка Пеппа',image:'https://image.tmdb.org/t/p/original/3LvhLvxslnK2ZEzLr1vvw1Ep9ND.jpg'}
];
...
function speak(text){if(!('speechSynthesis'in window))return;speechSynthesis.cancel();const u=new SpeechSynthesisUtterance(text);u.lang=/[äöüß]/i.test(text)?'de-DE':'ru-RU';u.rate=.92;u.pitch=1;speechSynthesis.speak(u)}
